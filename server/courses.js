/**
 * ISHAMI course catalog (server copy).
 *
 * Mirrors the front-end catalog in src/data/courses.ts so the Public API can
 * serve the same bilingual course data. Keep the two files in sync when course
 * content changes.
 *
 * Ferrivox Ltd © 2026
 */
  ...
  },
  {
    ...
    curriculum: {
      ...
      lessons: [
        ...
        { id: 4, title: 'Fuel Efficiency & Eco-Driving', titleKiny: "Gukoresha Amavunja n'Kubaga mu Buryo bw'Ibumeri", type: 'video', duration: '30 min', description: 'Techniques for fuel-efficient and environmentally-friendly driving.' },
