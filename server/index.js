...
const RW_TO_EN_MAP = {
  ...
  "Icyapa cyerekana umuvuduko ntarengwa ikinyabiziga kitagomba kurenza gishyirwa gusa ku binyabiziga bifite uburemere ntarengwa bukurikira:": "A sign showing maximum speed a vehicle must not exceed is placed only on vehicles with the following maximum weight:",
  ...
  "Umuyobozi": "A driver", "Umuherekeza": "A passenger", "Abanyamaguru": "Pedestrians",
  ...
  "Biteganye": "In single file", "Ku murongo umwe": "In single line",
  ...
  "Burenga toni 1": "Over 1 ton", "Burenga toni 2": "Over 2 tons",
  "Burenga toni 24": "Over 24 tons", "Burenga toni 12": "Over 12 tons",
  "Km50": "50 km/h", "Km40": "40 km/h", "Km30": "30 km/h",
  "Km25": "25 km/h", "Km70": "70 km/h",
  "Km 60 mu isaha": "60 km per hour", "Km 75 mu isaha": "75 km per hour", "Km20 mu isaha": "20 km per hour",
  ...
  "cm75": "75 cm", "cm125": "125 cm", "cm265": "265 cm", "cm25": "25 cm", "cm45": "45 cm",
  "Metero 100": "100 meters", "Metero 200": "200 meters", "Metero 50": "50 meters", "Metero 150": "150 meters",
...
app.post('/api/admin/translate-questions', authMiddleware, adminOnly, async (req, res) => {
  try {
    ...
    for (const q of questions) {
      ...
      if (questionEn || optionsEn.some(o => o.text !== (q.options || []).find(orig => orig.text === o.text)?.text)) {
        const update = {};
        if (questionEn) update.questionEn = questionEn;
        if (optionsEn.length > 0) update.optionsEn = optionsEn;
        await Question.findByIdAndUpdate(q._id, update);
        updated++;
      } else { skipped++; }
    }
    res.json({ success: true, updated, skipped, total: questions.length });
  } catch (e) {
