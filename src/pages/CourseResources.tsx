  ...
  return (
    ...
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Filter buttons */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="flex flex-wrap justify-center gap-3 mb-10">
        ...
        {/* Empty state */}
        {!loading && !courseLoading && filtered.length === 0 && (
