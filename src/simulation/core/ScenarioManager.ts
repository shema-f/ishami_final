...
export const ALL_SCENARIOS: ScenarioDefinition[] = [
  // ─── Low Poly City Scenarios (First 6 — Beginner) ───
  {
    ...
    description: 'The very first lesson: start your engine, select first gear, and drive forward 5 meters.',
    descriptionRW: 'Igitangira: tangira injini, hitamo igeari ya mbere, kandi ujye imbere metero 5.',
    difficulty: 'BEGINNER',
    estimatedTime: '1-2 min',
    location: 'Low Poly City — Main Road',
  ...
  },
  {
    ...
    description: 'Navigate through traffic lights and zebra crossings with animated cars and pedestrians.',
    descriptionRW: 'Gukemura mu myubahirirane y\'amatara y\'umuhanda no zebra.',
    difficulty: 'BEGINNER',
  ...
  },
  {
    ...
    title: 'Corners & Turns',
    titleRW: 'Imfuruka',
    description: 'Navigate corners and turns through the city while staying on the road.',
  ...
  },
  {
    ...
    description: 'Practice reversing in a straight line and turning corners while reversing.',
  ...
  },
  {
    ...
    description: 'Drive forward and park your car precisely between two parked vehicles.',
  ...
  },
  {
    ...
    description: 'Practice stopping and starting at intersections and stop signs.',
    descriptionRW: 'Jya mu gihe uhagarika no utangira.',
    difficulty: 'BEGINNER',
    estimatedTime: '2-4 min',
